...
<img src="img/卷积_02.png"/>

卷积核W，展开为列向量如下：

<img src="img/卷积_03.png"/>

我们将每次卷积计算时，卷积核覆盖的元素分别列出如下：

<img src="img/卷积_04.png"/>

将这些展开的元素行向量组合为矩阵如下：

<img src="img/卷积_05.png"/>

则卷积过程可表示为如下矩阵乘：

<img src="img/卷积_06.png"/>
...
<img src="img/卷积_07.png"/>

通道2：

<img src="img/卷积_08.png"/>



最终卷积结果应该为：

<img src="img/卷积_09.png"/>



在代码实现中以Caffe和darknet为例，上述数据在经过im2col处理后应当如下

<img src="img/卷积_10.png"/>
